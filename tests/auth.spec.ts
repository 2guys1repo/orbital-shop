...
test('able to login and logout', async ({ page }) => {
  await page.goto('/');
  // login
...
// test.fixme("able to register new account", async ({ page, browser }) => {
//   test.slow();
//   await page.goto('/');
//   // register
...
//   await page.getByTestId('auth-email-field').fill(randomHex + "@mail7.io");
//   await page.getByTestId('auth-submit-button').click();
