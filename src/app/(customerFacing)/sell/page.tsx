    ...
    <Card className="max-w-md mx-auto">
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Input className="mt-1" id="title" placeholder="Enter listing title" type="text" />
        </div>
        <div>
          <Label htmlFor="description">Description</Label>
          <Textarea className="mt-1" id="description" placeholder="Include details for other buyers" rows={3} />
        </div>
        <div>
