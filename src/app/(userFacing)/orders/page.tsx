...
function OrderStatusDropdown({ status, orderId }: { status: string, orderId: number }) {
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        <DropdownItem nextStatus="pending" orderId={orderId}>
          Pending
        </DropdownItem>
        <DropdownItem nextStatus="shipped" orderId={orderId} >
          Shipped
        </DropdownItem>
        <DropdownItem nextStatus="rejected" orderId={orderId} >
          Rejected
        </DropdownItem>
      </DropdownMenuContent>
    </DropdownMenu>
